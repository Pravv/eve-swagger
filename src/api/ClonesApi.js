...
(function(root, factory) {
  if (typeof define === 'function' && define.amd) {
    ...
    define(['ApiClient', 'model/GetCharactersCharacterIdClonesForbidden', 'model/GetCharactersCharacterIdClonesInternalServerError', 'model/GetCharactersCharacterIdClonesOk'], factory);
  } else if (typeof module === 'object' && module.exports) {
    // CommonJS-like environments that support module.exports, like Node.
    module.exports = factory(require('../ApiClient'), require('../model/GetCharactersCharacterIdClonesForbidden'), require('../model/GetCharactersCharacterIdClonesInternalServerError'), require('../model/GetCharactersCharacterIdClonesOk'));
  } else {
    // Browser globals (root is window)
    if (!root.EveSwaggerInterface) {
      root.EveSwaggerInterface = {};
    }
    root.EveSwaggerInterface.ClonesApi = factory(root.EveSwaggerInterface.ApiClient, root.EveSwaggerInterface.GetCharactersCharacterIdClonesForbidden, root.EveSwaggerInterface.GetCharactersCharacterIdClonesInternalServerError, root.EveSwaggerInterface.GetCharactersCharacterIdClonesOk);
  }
}(this, function(ApiClient, GetCharactersCharacterIdClonesForbidden, GetCharactersCharacterIdClonesInternalServerError, GetCharactersCharacterIdClonesOk) {
  'use strict';
