...
(function(root, factory) {
  if (typeof define === 'function' && define.amd) {
    ...
    define(['ApiClient', 'model/GetCharactersCharacterIdLocationForbidden', 'model/GetCharactersCharacterIdLocationInternalServerError', 'model/GetCharactersCharacterIdLocationOk', 'model/GetCharactersCharacterIdOnlineForbidden', 'model/GetCharactersCharacterIdOnlineInternalServerError', 'model/GetCharactersCharacterIdShipForbidden', 'model/GetCharactersCharacterIdShipInternalServerError', 'model/GetCharactersCharacterIdShipOk'], factory);
  } else if (typeof module === 'object' && module.exports) {
    // CommonJS-like environments that support module.exports, like Node.
    module.exports = factory(require('../ApiClient'), require('../model/GetCharactersCharacterIdLocationForbidden'), require('../model/GetCharactersCharacterIdLocationInternalServerError'), require('../model/GetCharactersCharacterIdLocationOk'), require('../model/GetCharactersCharacterIdOnlineForbidden'), require('../model/GetCharactersCharacterIdOnlineInternalServerError'), require('../model/GetCharactersCharacterIdShipForbidden'), require('../model/GetCharactersCharacterIdShipInternalServerError'), require('../model/GetCharactersCharacterIdShipOk'));
  } else {
    // Browser globals (root is window)
    if (!root.EveSwaggerInterface) {
      root.EveSwaggerInterface = {};
    }
    root.EveSwaggerInterface.LocationApi = factory(root.EveSwaggerInterface.ApiClient, root.EveSwaggerInterface.GetCharactersCharacterIdLocationForbidden, root.EveSwaggerInterface.GetCharactersCharacterIdLocationInternalServerError, root.EveSwaggerInterface.GetCharactersCharacterIdLocationOk, root.EveSwaggerInterface.GetCharactersCharacterIdOnlineForbidden, root.EveSwaggerInterface.GetCharactersCharacterIdOnlineInternalServerError, root.EveSwaggerInterface.GetCharactersCharacterIdShipForbidden, root.EveSwaggerInterface.GetCharactersCharacterIdShipInternalServerError, root.EveSwaggerInterface.GetCharactersCharacterIdShipOk);
  }
}(this, function(ApiClient, GetCharactersCharacterIdLocationForbidden, GetCharactersCharacterIdLocationInternalServerError, GetCharactersCharacterIdLocationOk, GetCharactersCharacterIdOnlineForbidden, GetCharactersCharacterIdOnlineInternalServerError, GetCharactersCharacterIdShipForbidden, GetCharactersCharacterIdShipInternalServerError, GetCharactersCharacterIdShipOk) {
  'use strict';
