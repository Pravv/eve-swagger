...
(function(root, factory) {
  if (typeof define === 'function' && define.amd) {
    ...
    define(['ApiClient', 'model/GetInsurancePrices200Ok', 'model/GetInsurancePricesInternalServerError'], factory);
  } else if (typeof module === 'object' && module.exports) {
    // CommonJS-like environments that support module.exports, like Node.
    module.exports = factory(require('../ApiClient'), require('../model/GetInsurancePrices200Ok'), require('../model/GetInsurancePricesInternalServerError'));
  } else {
    // Browser globals (root is window)
    if (!root.EveSwaggerInterface) {
      root.EveSwaggerInterface = {};
    }
    root.EveSwaggerInterface.InsuranceApi = factory(root.EveSwaggerInterface.ApiClient, root.EveSwaggerInterface.GetInsurancePrices200Ok, root.EveSwaggerInterface.GetInsurancePricesInternalServerError);
  }
}(this, function(ApiClient, GetInsurancePrices200Ok, GetInsurancePricesInternalServerError) {
  'use strict';
