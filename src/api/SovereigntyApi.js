...
(function(root, factory) {
  if (typeof define === 'function' && define.amd) {
    ...
    define(['ApiClient', 'model/GetSovereigntyCampaigns200Ok', 'model/GetSovereigntyCampaignsInternalServerError', 'model/GetSovereigntyMap200Ok', 'model/GetSovereigntyMapInternalServerError', 'model/GetSovereigntyStructures200Ok', 'model/GetSovereigntyStructuresInternalServerError'], factory);
  } else if (typeof module === 'object' && module.exports) {
    // CommonJS-like environments that support module.exports, like Node.
    module.exports = factory(require('../ApiClient'), require('../model/GetSovereigntyCampaigns200Ok'), require('../model/GetSovereigntyCampaignsInternalServerError'), require('../model/GetSovereigntyMap200Ok'), require('../model/GetSovereigntyMapInternalServerError'), require('../model/GetSovereigntyStructures200Ok'), require('../model/GetSovereigntyStructuresInternalServerError'));
  } else {
    // Browser globals (root is window)
    if (!root.EveSwaggerInterface) {
      root.EveSwaggerInterface = {};
    }
    root.EveSwaggerInterface.SovereigntyApi = factory(root.EveSwaggerInterface.ApiClient, root.EveSwaggerInterface.GetSovereigntyCampaigns200Ok, root.EveSwaggerInterface.GetSovereigntyCampaignsInternalServerError, root.EveSwaggerInterface.GetSovereigntyMap200Ok, root.EveSwaggerInterface.GetSovereigntyMapInternalServerError, root.EveSwaggerInterface.GetSovereigntyStructures200Ok, root.EveSwaggerInterface.GetSovereigntyStructuresInternalServerError);
  }
}(this, function(ApiClient, GetSovereigntyCampaigns200Ok, GetSovereigntyCampaignsInternalServerError, GetSovereigntyMap200Ok, GetSovereigntyMapInternalServerError, GetSovereigntyStructures200Ok, GetSovereigntyStructuresInternalServerError) {
  'use strict';
