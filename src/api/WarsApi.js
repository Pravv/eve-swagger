...
(function(root, factory) {
  if (typeof define === 'function' && define.amd) {
    ...
    define(['ApiClient', 'model/GetWarsInternalServerError', 'model/GetWarsWarIdInternalServerError', 'model/GetWarsWarIdKillmails200Ok', 'model/GetWarsWarIdKillmailsInternalServerError', 'model/GetWarsWarIdKillmailsUnprocessableEntity', 'model/GetWarsWarIdOk', 'model/GetWarsWarIdUnprocessableEntity'], factory);
  } else if (typeof module === 'object' && module.exports) {
    // CommonJS-like environments that support module.exports, like Node.
    module.exports = factory(require('../ApiClient'), require('../model/GetWarsInternalServerError'), require('../model/GetWarsWarIdInternalServerError'), require('../model/GetWarsWarIdKillmails200Ok'), require('../model/GetWarsWarIdKillmailsInternalServerError'), require('../model/GetWarsWarIdKillmailsUnprocessableEntity'), require('../model/GetWarsWarIdOk'), require('../model/GetWarsWarIdUnprocessableEntity'));
  } else {
    // Browser globals (root is window)
    if (!root.EveSwaggerInterface) {
      root.EveSwaggerInterface = {};
    }
    root.EveSwaggerInterface.WarsApi = factory(root.EveSwaggerInterface.ApiClient, root.EveSwaggerInterface.GetWarsInternalServerError, root.EveSwaggerInterface.GetWarsWarIdInternalServerError, root.EveSwaggerInterface.GetWarsWarIdKillmails200Ok, root.EveSwaggerInterface.GetWarsWarIdKillmailsInternalServerError, root.EveSwaggerInterface.GetWarsWarIdKillmailsUnprocessableEntity, root.EveSwaggerInterface.GetWarsWarIdOk, root.EveSwaggerInterface.GetWarsWarIdUnprocessableEntity);
  }
}(this, function(ApiClient, GetWarsInternalServerError, GetWarsWarIdInternalServerError, GetWarsWarIdKillmails200Ok, GetWarsWarIdKillmailsInternalServerError, GetWarsWarIdKillmailsUnprocessableEntity, GetWarsWarIdOk, GetWarsWarIdUnprocessableEntity) {
  'use strict';
