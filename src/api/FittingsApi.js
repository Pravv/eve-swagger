...
(function(root, factory) {
  if (typeof define === 'function' && define.amd) {
    ...
    define(['ApiClient', 'model/DeleteCharactersCharacterIdFittingsFittingIdForbidden', 'model/DeleteCharactersCharacterIdFittingsFittingIdInternalServerError', 'model/GetCharactersCharacterIdFittings200Ok', 'model/GetCharactersCharacterIdFittingsForbidden', 'model/GetCharactersCharacterIdFittingsInternalServerError', 'model/PostCharactersCharacterIdFittingsCreated', 'model/PostCharactersCharacterIdFittingsFitting', 'model/PostCharactersCharacterIdFittingsForbidden', 'model/PostCharactersCharacterIdFittingsInternalServerError'], factory);
  } else if (typeof module === 'object' && module.exports) {
    // CommonJS-like environments that support module.exports, like Node.
    module.exports = factory(require('../ApiClient'), require('../model/DeleteCharactersCharacterIdFittingsFittingIdForbidden'), require('../model/DeleteCharactersCharacterIdFittingsFittingIdInternalServerError'), require('../model/GetCharactersCharacterIdFittings200Ok'), require('../model/GetCharactersCharacterIdFittingsForbidden'), require('../model/GetCharactersCharacterIdFittingsInternalServerError'), require('../model/PostCharactersCharacterIdFittingsCreated'), require('../model/PostCharactersCharacterIdFittingsFitting'), require('../model/PostCharactersCharacterIdFittingsForbidden'), require('../model/PostCharactersCharacterIdFittingsInternalServerError'));
  } else {
    // Browser globals (root is window)
    if (!root.EveSwaggerInterface) {
      root.EveSwaggerInterface = {};
    }
    root.EveSwaggerInterface.FittingsApi = factory(root.EveSwaggerInterface.ApiClient, root.EveSwaggerInterface.DeleteCharactersCharacterIdFittingsFittingIdForbidden, root.EveSwaggerInterface.DeleteCharactersCharacterIdFittingsFittingIdInternalServerError, root.EveSwaggerInterface.GetCharactersCharacterIdFittings200Ok, root.EveSwaggerInterface.GetCharactersCharacterIdFittingsForbidden, root.EveSwaggerInterface.GetCharactersCharacterIdFittingsInternalServerError, root.EveSwaggerInterface.PostCharactersCharacterIdFittingsCreated, root.EveSwaggerInterface.PostCharactersCharacterIdFittingsFitting, root.EveSwaggerInterface.PostCharactersCharacterIdFittingsForbidden, root.EveSwaggerInterface.PostCharactersCharacterIdFittingsInternalServerError);
  }
}(this, function(ApiClient, DeleteCharactersCharacterIdFittingsFittingIdForbidden, DeleteCharactersCharacterIdFittingsFittingIdInternalServerError, GetCharactersCharacterIdFittings200Ok, GetCharactersCharacterIdFittingsForbidden, GetCharactersCharacterIdFittingsInternalServerError, PostCharactersCharacterIdFittingsCreated, PostCharactersCharacterIdFittingsFitting, PostCharactersCharacterIdFittingsForbidden, PostCharactersCharacterIdFittingsInternalServerError) {
  'use strict';
