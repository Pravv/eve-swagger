...
> [GetCharactersCharacterIdWalletsJournal200Ok] getCharactersCharacterIdWalletsJournal(characterId, opts)
...
apiInstance.getCharactersCharacterIdWalletsJournal(characterId, opts, callback);
```
...
[**[GetCharactersCharacterIdWalletsJournal200Ok]**](GetCharactersCharacterIdWalletsJournal200Ok.md)
