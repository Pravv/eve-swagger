...
var characterId = 56; // Number | The character to retrieve events from
...
------------- | ------------- | ------------- | -------------
 **characterId** | **Number**| The character to retrieve events from | 
...
var characterId = 56; // Number | The character id requesting the event
...
Name | Type | Description  | Notes
------------- | ------------- | ------------- | -------------
 **characterId** | **Number**| The character id requesting the event | 
