...
(function(root, factory) {
  ...
  describe('GetUniverseStructuresStructureIdPosition', function() {
    it('should create an instance of GetUniverseStructuresStructureIdPosition', function() {
      // uncomment below and update the code to test GetUniverseStructuresStructureIdPosition
      //var instane = new EveSwaggerInterface.GetUniverseStructuresStructureIdPosition();
