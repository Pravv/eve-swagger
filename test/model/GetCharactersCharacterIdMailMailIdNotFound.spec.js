...
(function(root, factory) {
  ...
  describe('GetCharactersCharacterIdMailMailIdNotFound', function() {
    it('should create an instance of GetCharactersCharacterIdMailMailIdNotFound', function() {
      // uncomment below and update the code to test GetCharactersCharacterIdMailMailIdNotFound
      //var instane = new EveSwaggerInterface.GetCharactersCharacterIdMailMailIdNotFound();
