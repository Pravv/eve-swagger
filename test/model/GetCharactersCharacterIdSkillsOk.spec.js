...
(function(root, factory) {
  ...
  describe('GetCharactersCharacterIdSkillsOk', function() {
    it('should create an instance of GetCharactersCharacterIdSkillsOk', function() {
      // uncomment below and update the code to test GetCharactersCharacterIdSkillsOk
      //var instane = new EveSwaggerInterface.GetCharactersCharacterIdSkillsOk();
    ...
    it('should have the property totalSp (base name: "total_sp")', function() {
      // uncomment below and update the code to test the property totalSp
      //var instane = new EveSwaggerInterface.GetCharactersCharacterIdSkillsOk();
      //expect(instance).to.be();
    });
