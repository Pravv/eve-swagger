...
(function(root, factory) {
  ...
  describe('GetUniverseSchematicsSchematicIdOk', function() {
    it('should create an instance of GetUniverseSchematicsSchematicIdOk', function() {
      // uncomment below and update the code to test GetUniverseSchematicsSchematicIdOk
      //var instane = new EveSwaggerInterface.GetUniverseSchematicsSchematicIdOk();
    ...
    it('should have the property schematicName (base name: "schematic_name")', function() {
      // uncomment below and update the code to test the property schematicName
      //var instane = new EveSwaggerInterface.GetUniverseSchematicsSchematicIdOk();
      //expect(instance).to.be();
    });
