...
(function(root, factory) {
  ...
  describe('GetCharactersCharacterIdStandings200Ok', function() {
    it('should create an instance of GetCharactersCharacterIdStandings200Ok', function() {
      // uncomment below and update the code to test GetCharactersCharacterIdStandings200Ok
      //var instane = new EveSwaggerInterface.GetCharactersCharacterIdStandings200Ok();
