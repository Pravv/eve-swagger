...
(function(root, factory) {
  ...
  describe('GetCharactersCharacterIdMailMailIdRecipient', function() {
    it('should create an instance of GetCharactersCharacterIdMailMailIdRecipient', function() {
      // uncomment below and update the code to test GetCharactersCharacterIdMailMailIdRecipient
      //var instane = new EveSwaggerInterface.GetCharactersCharacterIdMailMailIdRecipient();
