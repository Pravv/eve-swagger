...
(function(root, factory) {
  ...
  describe('GetCharactersCharacterIdOrders200Ok', function() {
    it('should create an instance of GetCharactersCharacterIdOrders200Ok', function() {
      // uncomment below and update the code to test GetCharactersCharacterIdOrders200Ok
      //var instane = new EveSwaggerInterface.GetCharactersCharacterIdOrders200Ok();
    ...
    it('should have the property isCorp (base name: "is_corp")', function() {
      // uncomment below and update the code to test the property isCorp
      //var instane = new EveSwaggerInterface.GetCharactersCharacterIdOrders200Ok();
      //expect(instance).to.be();
    });
