...
(function(root, factory) {
  ...
  describe('GetCharactersCharacterIdMailRecipient', function() {
    it('should create an instance of GetCharactersCharacterIdMailRecipient', function() {
      // uncomment below and update the code to test GetCharactersCharacterIdMailRecipient
      //var instane = new EveSwaggerInterface.GetCharactersCharacterIdMailRecipient();
