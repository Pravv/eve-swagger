...
(function(root, factory) {
  ...
  describe('GetCharactersCharacterIdBookmarksFolders200Ok', function() {
    it('should create an instance of GetCharactersCharacterIdBookmarksFolders200Ok', function() {
      // uncomment below and update the code to test GetCharactersCharacterIdBookmarksFolders200Ok
      //var instane = new EveSwaggerInterface.GetCharactersCharacterIdBookmarksFolders200Ok();
