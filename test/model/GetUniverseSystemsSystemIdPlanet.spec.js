...
(function(root, factory) {
  ...
  describe('GetUniverseSystemsSystemIdPlanet', function() {
    it('should create an instance of GetUniverseSystemsSystemIdPlanet', function() {
      // uncomment below and update the code to test GetUniverseSystemsSystemIdPlanet
      //var instane = new EveSwaggerInterface.GetUniverseSystemsSystemIdPlanet();
    ...
    it('should have the property moons (base name: "moons")', function() {
      // uncomment below and update the code to test the property moons
      //var instane = new EveSwaggerInterface.GetUniverseSystemsSystemIdPlanet();
