  ...
  describe('CalendarApi', function() {
    describe('getCharactersCharacterIdCalendar', function() {
      it('should call getCharactersCharacterIdCalendar successfully', function(done) {
        //uncomment below and update the code to test getCharactersCharacterIdCalendar
        //instance.getCharactersCharacterIdCalendar(function(error) {
    ...
    describe('getCharactersCharacterIdCalendarEventId', function() {
      it('should call getCharactersCharacterIdCalendarEventId successfully', function(done) {
        //uncomment below and update the code to test getCharactersCharacterIdCalendarEventId
        //instance.getCharactersCharacterIdCalendarEventId(function(error) {
        //  if (error) throw error;
        //expect().to.be();
        //});
        done();
    ...
    describe('putCharactersCharacterIdCalendarEventId', function() {
      it('should call putCharactersCharacterIdCalendarEventId successfully', function(done) {
        //uncomment below and update the code to test putCharactersCharacterIdCalendarEventId
        //instance.putCharactersCharacterIdCalendarEventId(function(error) {
        //  if (error) throw error;
        //expect().to.be();
        //});
        done();
